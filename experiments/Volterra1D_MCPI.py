...
if __name__ == "__main__":
	...
	ax1.set_title(f"Solving 1D Volterra integral equation using MC-{model.name}", fontsize=fontsize)
	...
	ax2.set_ylabel("Absolute error (log scale)", fontsize=fontsize)
	ax2.set_yscale('log')
	ax2.set_title("Absolute error between predicted and exact solution", fontsize=fontsize)
